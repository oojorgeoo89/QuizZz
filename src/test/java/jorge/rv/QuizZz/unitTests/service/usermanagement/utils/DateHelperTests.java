...
public class DateHelperTests {
	...
	private static int VALID_OFFSET = 5;
	private static int NEGATIVE_OFFSET = -5;
	...
	public void calculateValidExpirationDate() {
		Date expirationDate = dateHelper.getExpirationDate(FIXED_DATE, VALID_OFFSET);
	...
	public void calculateNegativeExpirationDate_shouldReturnFromDate() {
		Date expirationDate = dateHelper.getExpirationDate(FIXED_DATE, NEGATIVE_OFFSET);
